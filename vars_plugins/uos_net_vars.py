...
DOCUMENTATION = '''
    ...
    description:
        - Load YAML variable into ansible host corresponding to "hostname_in_inventory" in csv_vars/servers.csv file.
    options:
      _valid_extensions:
        default: [".csv"]
'''
                ...
                try:
                    ...
                    for found in found_files:
                        ...
                        for row_data in new_data:
                            hostname_in_csv = row_data['hostname'].split('.')[0]
                            hostname_in_inventory = entity.name.split('.')[0]
                            if hostname_in_csv == hostname_in_inventory:
